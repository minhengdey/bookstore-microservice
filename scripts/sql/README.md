...
| 04 | `03_book_db_seed.sql` | book_db | books, book_authors, book_categories, book_genres, book_publishers, book_images, book_conditions, book_languages |
| 05 | `04_staff_db_seed.sql` | staff_db | staff_users, inventory_staff |
| 06 | `05_cart_db_seed.sql` | cart_db | carts, cart_items |
| 07 | `06_order_db_seed.sql` | order_db | discounts, orders, order_items, order_discounts, invoices, coupons |
| 08 | `07_pay_db_seed.sql` | pay_db | payment_methods, payments, transactions, customer_payment_methods |
| 09 | `08_ship_db_seed.sql` | ship_db | shipping_methods, shipping_features, shippings, shipping_addresses, shipping_statuses |
| 10 | `09_manager_db_seed.sql` | manager_db | warehouses, warehouse_locations, suppliers, inventories, purchase_orders, purchase_order_items, stock_movements, stock_movement_logs, stock_transfers |
| 11 | `10_comment_rate_db_seed.sql` | comment_rate_db | book_reviews |
| 12 | `11_recommender_db_seed.sql` | recommender_db | recommendation_logs |
...
5. Lặp lại với từng DB: `catalog_db` → mở `02_catalog_db_seed.sql`, `product_db` → mở `12_product_db_seed.sql`, `book_db` → `03_book_db_seed.sql`, … đến `11_recommender_db_seed.sql`.
...
$PsqlPath = "psql"
$dbs = @('customer_db','catalog_db','product_db','book_db','staff_db','cart_db','order_db','pay_db','ship_db','manager_db','comment_rate_db','recommender_db')
$i = 1
foreach ($db in $dbs) {
