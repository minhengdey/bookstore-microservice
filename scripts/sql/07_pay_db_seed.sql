...
(1, 'Thanh toán giả lập', 'Mô phỏng thanh toán (tự động thành công)', true);
...
(1, 1, NOW(), 150800, 1, 'completed', 'TXN001', 1),
(2, 2, NOW(), 83000, 1, 'completed', 'TXN002', NULL);
...
(1, 1, 1, '***1234', true, true),
(2, 2, 1, '***1234', false, true);
